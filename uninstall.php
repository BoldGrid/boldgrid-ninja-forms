...
if( (isset ( $settings['delete_on_uninstall'] ) && 1 == $settings['delete_on_uninstall']) || !empty($boldgrid_forms['force_uninstall']) ) {
	...
	//BoldGrid prevent non-existant tables from erroring on DROP by	changing to DROP IF EXISTS
